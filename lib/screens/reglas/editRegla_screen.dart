...
class EditReglaScreen extends StatefulWidget {
  final Regla regla;
  EditReglaScreen({required this.regla});

  @override
  _EditReglaScreenState createState() => _EditReglaScreenState();
}

class _EditReglaScreenState extends State<EditReglaScreen> {
  ...
  late List<AreaComun> areasSeleccionadas;

  @override
  void initState() {
    super.initState();
    _nombreController = TextEditingController(text: widget.regla.nombre);
    _descripcionController = TextEditingController(text: widget.regla.descripcion ?? '');
    activo = widget.regla.activo;
    areasSeleccionadas = List.from(widget.regla.areas);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Editar Regla', style: TextStyle(fontFamily: 'Montserrat', fontWeight: FontWeight.bold, color: Colors.white)),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          final reglaActualizada = Regla(
                            id: widget.regla.id,
                            nombre: _nombreController.text,
                            descripcion: _descripcionController.text.isEmpty ? null : _descripcionController.text,
                            areas: List.from(areasSeleccionadas),
                            activo: activo,
                            creado: widget.regla.creado,
                            actualizado: DateTime.now(),
                          );
                          
                          // Aquí implementarías la lógica para actualizar la regla
                          // Por ahora solo navegamos de vuelta
                          
                          Navigator.pop(context, reglaActualizada);
                        }
                      },
                      child: Text(
                        'Guardar Cambios', 
